...
// Используйте ключевое слово let для объявления переменных profession и age. Инициализируйте profession строкой "teacher", а переменную age не инициализируйте
